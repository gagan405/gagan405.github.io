...
After years now, I thought of having it as a generic LRU cache library for rust, with some acceptable level of customization
and metrics to actually show if the dudup cache is a good fit or not.

Here is the [first version](https://crates.io/crates/dedup-cache) of it published today.
