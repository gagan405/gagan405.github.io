...
[taxonomies]
tags=["java", "powermock", "jdk", "migration"]
+++
...
Before anything else, this shows the improvements in the overall GC time after JDK17 migration.

![gc improvements](./jdk-gc-improvements.webp)
...
__Static methods from Thread/System classes:__
